...
Eledt <- rasterToPoints(Ocean_DEM)
...
RiverTaiwan <- ggplot()+
  ...
  annotation_north_arrow(location = "tl", which_north = "true",   #North
                         ...
                         style = north_arrow_fancy_orienteering(text_col = '#00b1b1', 
                                                                line_col = '#00b1b1',
                                                                fill = '#00b1b1'))+
  coord_sf(xlim = c(119.4, 123.0), ylim = c(21.5, 25.8), expand = FALSE, crs=4326)+
  theme(panel.background = element_rect(fill = "#003b4f", color="#003b4f"), 
        panel.grid = element_blank(), 
        plot.background = element_rect(fill = "#003b4f", color="#003b4f"),
        plot.margin = margin(0.3, 0.3, 0.3, -0.1, "cm"),
        axis.text.x = element_text(vjust = 10, size=8.4, color="#00b1b1"),
        axis.text.y = element_text(angle = 270, vjust = 8.5, hjust=0.5, size=8, color="#00b1b1"),
...
#--output--
ggexport(RiverTaiwan, filename = "Taiwan River map202312.png", width =5000, height =6670, res =900 )
