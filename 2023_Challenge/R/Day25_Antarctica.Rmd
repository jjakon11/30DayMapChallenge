...
Antac <- ggplot()+
  ...
  scale_y_continuous(limits = c(-90, -20), 
                     ...
                     expand = c(0, 0)) +
  geom_text(mapping=aes(x = seq(30, 150, by = 30), y = -55),
                        label = paste0(seq(30, 150, by = 30),"°E" ), 
            hjust=0.5,size=30, color="#d8dddf") +
  geom_text(mapping=aes(x = seq(210, 330, by = 30), y = -55),
                        label = paste0(c(150, 120, 90, 60, 30),"°W" ), 
            hjust=0.5,size=30, color="#d8dddf") +
  geom_text(mapping=aes(x = 280, y = seq(-50, -80, by = -10),
                        label = paste0(seq(50, 80, by = 10), "°S")), 
            hjust=0.5,size=30, color="#d8dddf") +
  geom_rect(aes(xmin = 3, xmax = 44, ymin =-35, ymax = -57), 
            fill="#49524C", alpha=0.88)+
